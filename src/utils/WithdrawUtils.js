...
import { getWasteBanksCustomers, getWasteBanksWithdraw, acceptWasteBanksWithdraw, getUsersWithdraw, createUsersWithdraw } from "@constants/apiWithdraw";
...
class WithdrawUtils {
    ...
    async getWasteBanksCustomers(params) {
        ...
        return await getWasteBanksCustomers(params).then((response) => {
    ...
    async getWasteBanksWithdraw(params) {
        ...
        return await getWasteBanksWithdraw(params).then((response) => {
    ...
    async acceptWasteBanksWithdraw(params) {
        ...
        return await acceptWasteBanksWithdraw(params).then((response) => {
    ...
    async getUsersWithdraw(params) {
        ...
        return await getUsersWithdraw(params).then((response) => {
    ...
    async createUsersWithdraw(params) {
        return await createUsersWithdraw(params).then((response) => {
