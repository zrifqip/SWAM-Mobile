...
class WasteBanksUtils {
    ...
    async getWasteBanks(params) {
        return params = await getWasteBanks(params).then((response) => {
    ...
    async getWasteBanksDetails(params) {
        return params = await getWasteBanksDetails(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async getWasteBanksItems(params) {
        return params = await getWasteBanksItems(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async getWasteBanksProductCategory(params) {
        return params = await getWasteBanksProductCategory(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async addWasteBanksProductCategory(params) {
        return params = await addWasteBanksProductCategory(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async updateWasteBanksProductCategory(params) {
        return params = await updateWasteBanksProductCategory(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
                this.getWasteBanksProductCategory()
                return 200
    ...
    async getWasteBanksProduct(params) {
        return params = await getWasteBanksProduct(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async getWasteBanksProductDetail(params) {
        return params = await getWasteBanksProductDetail(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async addWasteBanksProduct(params) {
        return params = await addWasteBanksProduct(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async updateWasteBanksProduct(params) {
        return params = await updateWasteBanksProduct(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async deleteWasteBanksProduct(params) {
        return params = await deleteWasteBanksProduct(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
                this.getWasteBanksProduct()
                return 200
    ...
    async getWasteBanksSchedule(params) {
        return params = await getWasteBanksSchedule(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async getWasteBanksScheduleDetail(params) {
        return params = await getWasteBanksScheduleDetail(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async addWasteBanksSchedule(params) {
        return params = await addWasteBanksSchedule(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async updateWasteBanksSchedule(params) {
        return params = await updateWasteBanksSchedule(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
                this.getWasteBanksSchedule()
                return 200
    ...
    async deleteWasteBanksSchedule(params) {
        return params = await deleteWasteBanksSchedule(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
                this.getWasteBanksSchedule()
                return 200
    ...
    async getWasteBanksCompany(params) {
        return params = await getWasteBanksCompany(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async getWasteBanksCompanyItems(params) {
        ...
        return params = await getWasteBanksCompanyItems(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
                return store.dispatch(GetWasteBanksItems(respon.data))
            }
    ...
    async getSummary(params) {
        ...
        return params = await getSummary(params).then((response) => {
            const respon = response.data
            if(respon.status == "success"){
    ...
    async getCompanyDashboard(params) {
        ...
        return params = await getCompanyDashboard(params).then((response) => {
            const respon = response.data
    ...
    async getStock(params) {
        ...
        return params = await getStock(params).then((response) => {
            const respon = response.data
