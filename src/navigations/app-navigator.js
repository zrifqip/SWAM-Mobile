...
const MainTabsUsers = () => {
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
          ...
          return (
            <Text
              style={[
                ...
                {
                  fontSize: RFValue(10),
                  color: focused ? Colors.PRIMARY : Colors.GRAY_LABEL,
                },
              ]}>
              {title}
            </Text>
        ...
        tabBarIcon: ({ focused }) => {
          ...
          switch (route.name) {
            ...
            case "UsersTransaction":
              iconName = focused
                ? Icons.transactionTabActive
                : Icons.transactionTab;
              style = { width: wp(7), height: hp(4) };
              break;
            case "Account":
      ...
      <Tab.Screen
        name="UsersWasteBank"
        component={UsersWasteBank}
        options={{ headerShown: false }}
      />
      <Tab.Screen
        name="UsersTransaction"
...
const MainTabWasteBank = () => {
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        name="WasteBankDashboard"
        component={WasteBankDashboard}
        options={{ headerShown: false }}
      />
      <Tab.Screen
        name="WasteBankProduct"
        component={WasteBankProduct}
        options={{ headerShown: false }}
      />
      <Tab.Screen
      ...
      />
      <Tab.Screen
        name="WasteBankTransaction"
        component={WasteBankTransaction}
        options={{ headerShown: false }}
      />
      <Tab.Screen
        name="Account"
...
const MainTabsCompany = () => {
  ...
  return (
    <Tab.Navigator
      ...
      />
      <Tab.Screen
        name="CompanyWasteBank"
        component={CompanyWasteBank}
        options={{ headerShown: false }}
      />
      <Tab.Screen
        name="Account"
    ...
    <Stack.Navigator>
      {user.role == "user" ? (
        ...
        <>
          ...
          />
          <Stack.Screen
            name="WasteBankProfile"
            component={WasteBankProfile}
            options={{
              headerShown: false,
              cardStyleInterpolator: HorizontalSlide,
            }}
          ...
          />
          <Stack.Screen
            name="WasteBankTransactionDetails"
            component={WasteBankTransactionDetails}
            options={{
              headerShown: false,
              cardStyleInterpolator: HorizontalSlide,
            }}
          />
          <Stack.Screen
            name="WasteBankCustomers"
            component={WasteBankCustomers}
            options={{
              headerShown: false,
              cardStyleInterpolator: HorizontalSlide,
            }}
        ...
        <>
          <Stack.Screen
            name="MainTabsCompany"
            component={MainTabsCompany}
            options={{ headerShown: false }}
          />
          <Stack.Screen
            name="CompanyProfile"
          ...
          />
          <Stack.Screen
            name="CompanyWasteBankDetail"
            component={CompanyWasteBankDetail}
            options={{
              headerShown: false,
              cardStyleInterpolator: HorizontalSlide,
            }}
      ...
      <Stack.Screen
        name="Chats"
        component={Chats}
        options={{ headerShown: false, cardStyleInterpolator: HorizontalSlide }}
      />
      <Stack.Screen
        name="ChatsRoom"
        component={ChatsRoom}
      ...
      />
      <Stack.Screen
        name="ResultsWasteBank"
        component={ResultsWasteBank}
        options={{ headerShown: false, cardStyleInterpolator: HorizontalSlide }}
      />
      <Stack.Screen
        name="UsersWasteBankDetail"
        component={UsersWasteBankDetail}
        options={{ headerShown: false, cardStyleInterpolator: HorizontalSlide }}
      />
      <Stack.Screen
        name="ResultsCategory"
        component={ResultsCategory}
        options={{ headerShown: false, cardStyleInterpolator: HorizontalSlide }}
      />
      <Stack.Screen
        name="ResultsSchedule"
        component={ResultsSchedule}
        options={{ headerShown: false, cardStyleInterpolator: HorizontalSlide }}
      />
      <Stack.Screen
        name="ResultsAddress"
      ...
      />
      <Stack.Screen
        name="ResultsCustomers"
        component={ResultsCustomers}
        options={{ headerShown: false, cardStyleInterpolator: HorizontalSlide }}
      />
    </Stack.Navigator>
  );
