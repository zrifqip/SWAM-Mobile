...
import { BaseContainer, TypographyText, ButtonFlex, AppBar, FormInput, ModalOTP } from '@components';
        ...
        <BaseContainer loading={loading}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{backgroundColor: Colors.WHITE}}>
                <View style={styles.authCont}>
                    <TypographyText text={translations["login"]} fontType="bold" fontSize="L"/>
                    <TypographyText
                        ...
                        {({ handleChange, handleSubmit, handleBlur, values, errors, touched }) => (
                            <>
                                ...
                                <ButtonFlex
                                    ...
                                    flex
                                />
                                <Text style={styles.labelSignIn}>{translations["dont.have.acc"]}<Text style={[Font.SemiBold, Font.PRIMARY]} onPress={actionNavigation.bind(this, 'SignUp')}>{translations["register"]}</Text></Text>
                            </>
                        )}
                    </Formik>
                </View>
