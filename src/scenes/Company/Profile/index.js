...
import { BaseContainer, AppBar, FormInput, ButtonFlex, FormInputPhoto } from '@components';
...
function CompanyProfile({ navigation, users }) {
    ...
    const [companyType, setCompanyType] = useState(user?.organization?.companyType)

    let organization, photo = ''
                ...
                {({ handleChange, handleSubmit, handleBlur, values, errors, touched }) => (
                    ...
                    <ScrollView>
                        <View style={styles.authCont}>
                            ...
                            />
                            <Text style={StC.title}>{translations["type"] + ' ' + translations["waste.bank"]} {requireds('*')}</Text>
