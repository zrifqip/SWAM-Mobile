...
import { BaseContainer, EmptyData, CardChats, AppBar, ButtonFab } from '@components';
    ...
    return (
        <BaseContainer loading={loading}>
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <EmptyData message={'Belum ada pesan!'}/>
                }
                refreshControl={<RefreshControl refreshing={loading} onRefresh={()=> getChats()}/>}
            />
