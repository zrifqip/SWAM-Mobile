            ...
            <View style={{ flex: 1, backgroundColor: '#eee4dc'}}>
                        ...
                        renderItem={({ item }) => {
                            const cellStyle = {
                                ...
                                textContainer: {
                                    ...
                                    backgroundColor: userID == item.userID ? '#dbf5b4' : '#bfbfbf',
                            ...
                            return (
                                <View style={cellStyle.container}>
                                    <View style={cellStyle.textContainer}>
                                        ...
                                        <Text style={styles.time}>{formatDateChatsDetail(item.datetime)}</Text>
                                    </View>
                                </View>
                            );
                        }}
                        refreshControl={<RefreshControl refreshing={loading} onRefresh={()=> _onNewMsg()}/>}
                    />
                </View>
                <View style={styles.cardFooter}>
                    ...
                    <TouchableOpacity style={styles.btn} onPress={()=> _sendMessage()}>
                        <Icon as={<FontAwesome name={'send'}/>} size={RFValue(5)} color={Colors.WHITE} />
                    </TouchableOpacity>
                </View>
            </View>
        </BaseContainer>
