...
import { View, ScrollView, Dimensions, Image, PermissionsAndroid, Text } from 'react-native';
    ...
    const callLocation = async () => {
        Geolocation.getCurrentPosition(
            (position) => {
                ...
                address.loc.coordinates = [position.coords.longitude, position.coords.latitude]
            ...
            >
                {({ handleChange, handleSubmit, handleBlur, values, errors, touched }) => (
                    ...
                    <ScrollView>
                        ...
                        <Text style={styles.longlat}>Long: {coordinate[0]}, Lat: {coordinate[1]}</Text>
