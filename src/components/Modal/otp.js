  ...
  render() {
    ...
    for (var i = 1; i <= 6; i++) {
      dotted.push(
        <DottedOTP
          activeStyle={
            inputOTP.length >= i ? styles.dottedActive : styles.dottedInActive
          }
        />,
      );
    }
      ...
      <RBSheet
        ...
        <View style={styles.modal}>
          ...
          <Text style={styles.descOTP}>
            OTP telah dikirimkan ke whatsapp yang telah Anda daftarkan
          </Text>
          <View style={styles.dottedContainer}>{dotted}</View>
          <FlatList
            data={number}
