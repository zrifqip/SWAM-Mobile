...
const FormInputCheckbox = (props) => (
    <TouchableOpacity onPress={props.onPress} style={[styles.card, props.style]}>
        <Icon as={MaterialCommunityIcons} name={props.checked ? "checkbox-marked" : "checkbox-blank-outline"} color={props.checked ? Colors.PRIMARY : Colors.GRAY} size={RFValue(5)} style={{height: RFValue(20), width: RFValue(20)}}/>
