...
const EmptyData = ({
    ...
    return (
        <Center style={{paddingTop: RFValue(list ? 50 : 200), paddingBottom: RFValue(list ? 80 : 0)}}>
            <Image source={Icons.emptyList} style={[small ? styles.small : styles.medium, {resizeMode: 'contain'}]} />
