                    ...
                    {schedule.map((item) => (
                        <View style={styles.cardItem}>
                            <View style={styles.icon}>
                                <Icon as={MaterialCommunityIcons} name={'timetable'} color={Colors.PRIMARY} size={RFValue(4)}/>
                            </View>
                            <Text style={styles.day}>{arrDay(item.day)} ({item.startTime} - {item.endTime})</Text>
                        </View>
                    ))}
                </View>   
            </ScrollView>
